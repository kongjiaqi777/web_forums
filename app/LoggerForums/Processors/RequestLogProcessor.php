...
class RequestLogProcessor extends Processor
{
    ...
    {
        $enabled = config('forumslogger.request_log.enabled', false);
        if (!$enabled) {
            return;
        }
    ...
    public function getPath()
    {
        ...
        $this->path = config('forumslogger.request_log.path');
        return $this->path;
    }
    ...
    public function getType()
    {
        ...
        $this->type = config('forumslogger.request_log.type');
        return $this->type;
    }
    ...
    public function getLevel()
    {
        ...
        $this->level = config('forumslogger.request_log.level', 'debug');
        return $this->level;
    }
    ...
    public function getFormat()
    {
        if (is_null($this->format)) {
            $this->format = config('forumslogger.request_log.format', self::DEFAULT_EXT_FORMAT);
        }
        return $this->format;
    }
