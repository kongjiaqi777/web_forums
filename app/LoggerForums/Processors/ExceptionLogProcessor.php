...
class ExceptionLogProcessor extends Processor
{
    ...
    {
        $enabled = config('forumslogger.exception_log.enabled', false);
        if (!$enabled) {
            return;
        }
    ...
    public function getPath()
    {
        ...
        $this->path = config('forumslogger.exception_log.path');
        return $this->path;
    }
    ...
    public function getType()
    {
        ...
        $this->type = config('forumslogger.exception_log.type');
        return $this->type;
    }
    ...
    public function getFormat()
    {
        if (is_null($this->format)) {
            $this->format = config('forumslogger.exception_log.format', self::DEFAULT_EXT_FORMAT);
        }
        return $this->format;
    }
    ...
    public function getLevel()
    {
        ...
        $this->level = config('forumslogger.exception_log.level', 'debug');
        return $this->level;
    }
