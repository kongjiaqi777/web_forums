...
class BaseLogProcessor extends Processor
{
    ...
    {
        $enabled = config('forumslogger.base_log.enabled', false);
        if (!$enabled) {
            return;
        }
    ...
    public function getPath()
    {
        ...
        $this->path = config('forumslogger.base_log.path');
        return $this->path;
    }
    ...
    public function getType()
    {
        ...
        $this->type = config('forumslogger.base_log.type');
        return $this->type;
    }
    ...
    public function getLevel()
    {
        ...
        $this->level = config('forumslogger.base_log.level', 'debug');
        return $this->level;
    }
    ...
    public function getFormat()
    {
        if (is_null($this->format)) {
            $this->format = config('forumslogger.base_log.format', self::DEFAULT_EXT_FORMAT);
        }
        return $this->format;
    }
    ...
    protected function writeLog($level, $message, $context)
    {
        ...
        if ($this->getType() === 'fluentd') {
            ...
            if (config('forumslogger.base_log.async', true) === false) {
